    ...
    milestones: [
        [
            ...
            [a=>{
                ...
                return x
            },x=>`Ultra & Meta-Prestige Levels start <b>${format(x)}倍</b>出现`],
            [a=>{
                let x = a.add(1).log10().div(5).add(1).root(2)
                return x
            },x=>`Boosts entropy gain by <b>${format(x)}次方</b>`],
            [a=>{
                let x = a.add(1).log10().add(1).pow(2)
                return x.toNumber()
            },x=>`Impossible Challenges 1-12 start <b>${format(x)}倍</b>出现`],
            [a=>{
            ...
            [a=>{
                ...
                return x
            },x=>`Boosts mass of unstable BH gain by <b>${format(x)}倍</b>`],
            [a=>{
                let x = a.add(1).pow(3)
                return x
