    ...
    */
    ...
    if (tmp.tab == 7) {
        if (tmp.stab[7] == 0) {
            ...
            if (eff.sn) e += `<br>Makes you becoming <b>${eff.sn.format(3)}倍</b> more supernovas`+eff.sn.softcapHTML(7.5,hasElement(9,1))
            ...
            if (tmp.chal14comp) {
                ...
                if (eff.accelPow) e += `<br>Boosts accelerator power by <b>${eff.accelPow.format(3)}倍</b>`+eff.accelPow.softcapHTML(5,hasElement(234))
                if (eff.ApQ_Overflow) e += `<br>Atomic power & quark overflows start <b>${eff.ApQ_Overflow.format(3)}次方</b> later`
