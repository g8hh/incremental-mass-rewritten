        ...
        if (tmp.stab[7] == 0) {
            ...
            if (tmp.chal14comp) {
                ...
                e = getNextDarkEffectFromID(2) + `
                    ...
                    <br>Makes mass gain's softcap^4-${hasElement(159)?8:6}, starting <b>${eff.msoftcap.format(3)}次方</b> later
                `
                ...
                if (eff.mexp) e += `<br>Boosts each matters gain by <b>${eff.mexp.format(3)}次方</b>`
