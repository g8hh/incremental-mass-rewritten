...
const CHALS = {
    ...
    getScaleName(i) {
        if (i < 16 && i != 16) {
            ...
            if (player.chal.comps[i].gte(i==13?5:i==8?200:i>8&&i!=13&&i!=16?50:300)) return "疯狂·"
            if (player.chal.comps[i].gte(i==13?2:i>8&&i!=13&&i!=16?10:75)) return "硬化-"
        } else {
            if (player.chal.comps[i].gte(10)) return "硬化-"
        }
        return ""
    },
    getPower(i) {
