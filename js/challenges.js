...
const CHALS = {
    ...
    getScaleName(i) {
        if (player.chal.comps[i].gte(i==13||i==16?10:1000)) return "无望~"
        if (player.chal.comps[i].gte(i==13||i==16?5:i==8?200:i>8&&i!=13&&i!=16?50:300)) return "疯狂·"
        if (player.chal.comps[i].gte(i==13||i==16?2:i>8&&i!=13&&i!=16?10:75)) return "硬化-"
        return ""
    },
    getPower(i) {
        let x = E(1)
