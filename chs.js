...
var cnItems = {
    ...
    'Dark Shadow\'s first reward is overpowered. Remove all scalings from Tickspeed.': '使黑暗之影的第一个效果变得滥强。移除时间速度的所有折算。',
    'Unlock Exotic Atoms in Atom tab, and unlock new elements\' layer.': '在原子选项卡下解锁奇异原子，并解锁新的元素层级。',
    'Remove all pre-Meta scalings from BHC. [Neut-Tau]\'s effect no longer affects BHC\'s cheapness.': '移除黑洞压缩器所有元折算之前的折算。使[陶中微子]的效果不再影响黑洞压缩器。',
    'Requires': '需',
    ' Corrupted Shard.': '腐化碎片。',
    //#endregion
    //#region 选项
    ...
    'Incremental Mass Rewritten v0.6.5 - made by MrRedShark77': '质量增量重制版v0.6.5 - 作者为MrRedShark77，由by22dgb汉化',
