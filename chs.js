...
var cnItems = {
    ...
    'Muon & Pion are doubled every muonic element bought.': '每购买一个μ子元素，就使μ子和π介子的获取速度翻倍。',
    ...
    ' Exotic Atoms (Muon & Pion based).': '奇异原子(基于μ子和π介子数量)。',
    ' Muons.': 'μ子。',
    ' Pions.': 'π介子。',
    ...
    'Best mass of black hole in C16 boosts Muon & Pion gain.': '使挑战16中最高的黑洞质量可以加成μ子和π介子的获取速度。',
    ...
    'Incremental Mass Rewritten v0.6.5.1 - made by MrRedShark77': '质量增量重制版v0.6.5.1 - 作者为MrRedShark77，由by22dgb汉化',
