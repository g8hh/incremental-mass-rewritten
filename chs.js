...
var cnItems = {
    ...
    '[qol3] Start with Techntium-43 unlocked, improve their element better. You can automatically gain Relativistic particles from mass.': '[qol3]初始状态下就解锁锝(Tc43)，并且相应的元素效果变得更好。您可以自动从质量中获得相对论粒子。',
    ...
    '[qu10] Higgs Boson\'s effect is increased by 3.3% for every OoM of Blueprint Particles.': '[qu10]蓝图粒子每有一个数量级，就使希格斯玻色子的效果增加3.3%。',
    '[qu11] Quantum Foams gain formula is better.': '[qu11]使量子泡沫获取速度的公式变得更好。',
