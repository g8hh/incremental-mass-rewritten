...
var cnItems = {
    ...
    'Require Oganesson-118 to go Dark': '需要购买气奥(118Og)才能融入黑暗',
    'Rank up.': '提升级别。',
    'Tier up.': '提升阶层。',
    'Tetr up.': '提升四重阶层。',
    'Super': '超级折算',
    ...
    'Super, Hyper Mass Upgrades scaling is weaker by Rage Points.': '使质量升级的超级折算和究极折算基于狂怒能量的数值而弱化。',
    ...
    'Mass of black hole boosts accelerator power at a extremely reduced rate.': '使黑洞质量可以加成加速器倍率，只是效果倍率极度降低。',
    'Atom Upgrades': '原子升级',
    ...
    'Yellow matter\'s upgrade applies dilated mass\'s overflow starting at reduced rate.': '使黄色物质的升级可以让膨胀质量的溢出延迟出现，只是效果倍率降低。',
    ...
    'Normal mass and mass of black hole gains are setting to lg(x)^^1.5.': '质量和黑洞质量变为原来的lg(x)^^1.5。',
    ...
    'The Tetr requirement is 15% weaker.': '使四重阶层的需求降低15%。',
    ...
    'Unlock Stars.': '解锁星辰。',
    'Super Tier scale weaker based on Tetr.': '使阶层的超级折算基于四重阶层的数值而弱化。',
    ...
    'You can afford Cerium-58 in Big Rip.': '您可以在大撕裂中购买铈(58Ce)了。',
    ...
    'You can afford Tungsten-74 in Big Rip.': '您可以在大撕裂中购买钨(74W)了。',
    'Start with break dilation unlocked. Relativistic energy gain is 10% stronger.': '初始状态下就解锁撕裂膨胀。使相对论能量获取速度增加10%。',
    ...
    'Dark shadow is boosted by death shard.': '使黑暗之影获取速度基于死寂碎片的数值而增加。',
    ...
    'Super & Hyper Cosmic Strings are 25% weaker.': '使宇宙弦的超级折算和究极折算弱化25%。',
    ...
    'Hyper Prestige Level, Tetr & Pent are 10% weaker.': '使转生等级、四重阶层和五重阶层的究极折算弱化10%。',
    ...
    'Unlock 16th Challenge. (Coming Soon...': '解锁挑战16。(制作中……',
    'inactive': '未激活',
    ...
    'You can\'t gain Delta, Alpha, Omega & Sigma Particles from Primordium Theorem now. Instead, add free their Particles equals to your total Primordium Theorems.': '您无法通过原基定理获得德尔塔、阿尔法、欧米伽和西格马粒子。但您可以根据原基定理的数值获得相同数值的相应粒子。',
    'You can\'t gain Phi & Epsilon Particles from Primordium Theorem now. Instead, add free their Particles equals to your total Primordium Theorems.': '您无法通过原基定理获得斐和艾普西隆粒子。但您可以根据原基定理的数值获得相同数值的相应粒子。',
    'You can\'t gain Theta & Beta Particles from Primordium Theorem now. Instead, add free their Particles equals to your total Primordium Theorems.': '您无法通过原基定理获得西塔和贝塔粒子。但您可以根据原基定理的数值获得相同数值的相应粒子。',
    ...
    'On Active: Active all above u-quarks at once, but force to quantum reset': '激活时，使之前所有U-夸克激活，并强制前往量子',
    ...
    'On Active: Active all above u-leptons at once, but force to quantum reset': '激活时，使之前所有U-轻子激活，并强制前往量子',
    ...
    'Require': '需',
    'To get Final Star Shard, reset dark shadows, abyssal blots and matters, and force to Darkness reset. It boosts matters and glyphic mass.': '获得最终星辰碎片时，将重置黑暗之影、深渊之渍和物质，并强制融入黑暗。它可以加成物质获取速度和雕文获取数量。',
    ' FSS base': '最终星辰碎片基础值',
    //#endregion
    //#region 选项
    'Save': '保存',
    ...
    'Incremental Mass Rewritten v0.6.3.3 - made by MrRedShark77': '质量增量重制版v0.6.3.3 - 作者为MrRedShark77，由by22dgb汉化',
