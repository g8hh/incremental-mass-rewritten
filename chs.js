...
var cnItems = {
    ...
    ' to Unstable BH production speed': '不稳定黑洞获取速度',
    ...
    'Super and Hyper mass upgrade scalings are weaker based on rage points.': '使质量升级的超级折算和究极折算基于狂怒能量的数值而弱化。',
    ...
    'Rage Points gain is rooted by 10. Additionally, mass gain softcap starts 100 OoMs eariler.': '狂怒能量获取速度变为原来的十次方根。另外，质量获取速度软上限提前100个数量级出现.',
    ...
    '• You cannot gain rage points nor dark matters, and all matters’ formula is disabled, and they generate each other. Red matter generates dark matter.': '• 您无法获得狂怒能量和暗物质，所有物质的公式都被禁用，它们会互相产生彼此。红色物质可以产生暗物质。',
    ...
    'Incremental Mass Rewritten v0.6.4.5 - made by MrRedShark77': '质量增量重制版v0.6.4.5 - 作者为MrRedShark77，由by22dgb汉化',
