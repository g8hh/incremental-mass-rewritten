...
var cnItems = {
    ...
    '• Pre-C16 following contents (including rank & prestige tiers, main upgrades, elements, tree and etc.) are corrupted like disabled.': '• 挑战16之前的相应内容(包括级别、转生、主要升级、元素、中子树等等)都受到了腐化，就像效果被禁用了一样',
    '• You are trapped in Mass Dilation & Dark Run with 100 all glyphs.': '• 您强制进行质量膨胀和黑暗狂奔，所有雕文为100。',
    ...
    'Best mass of black hole in C16 boosts normal mass gain.': '挑战16中最高的黑洞质量可以加成质量获取速度。',
    'Best mass of black hole in C16 boosts bosonic resources gain.': '挑战16中最高的黑洞质量可以加成玻色子获取速度。',
    'Best mass of black hole in C16 increases free fermion tiers.': '挑战16中最高的黑洞质量可以使费米子阶层额外增加。',
    'Best mass of black hole in C16 increases the base of each matter\'s upgrade.': '挑战16中最高的黑洞质量可以加成每种物质升级的基础值。',
    ...
    'Incremental Mass Rewritten v0.6.4.1 - made by MrRedShark77': '质量增量重制版v0.6.4.1 - 作者为MrRedShark77，由by22dgb汉化',
