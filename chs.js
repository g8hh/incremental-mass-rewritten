...
var cnItems = {
    ...
    ', your mass overflow is even stronger!': '，发生二重溢出，且变得更严重了！',
    ...
    ', your black hole mass overflow is even stronger!': '，发生溢出，且变得更严重了！',
    ' Atomic Power': '原子能量',
    ...
    ', your atomic power is raised by ': '，发生溢出，因此它变为了以下次方：',
    ', your atomic power is rooted by ': '，发生溢出，因此它变为了以下次方根：',
    ' You collapsed ': '您已经坍缩了',
    ' stars, which multiplies mass gain based on all rank types.': '星辰，质量获取速度基于级别的种类而增加',
    ' of collapsed stars gain will softcap collapsed stars gain!': '的坍缩星辰以后，坍缩星辰获取速度将受到软上限限制！',
    ...
    ' gained before ': '',
    ' Rage Power. (after Quantum)': '狂怒能量。(加成后最终效果)',
    ' Dark Matter. (after Quantum)': '暗物质。(加成后最终效果)',
    'Rage Power': '狂怒能量',
    'Require over ': '需要超过',
    ...
    'When dilating mass, will reset for atom. While mass is dilated: all pre-atom resources, atomic power gains get multiplier\'s exponent raised to 0.8.': '进行质量膨胀时将同时进行一次原子重置，质量膨胀时，所有原子之前的资源，及原子能量获取速度变为原来的0.8次方。',
    ' Collapsed Star.': '坍缩星辰。',
    'Reach over ': '到达超过',
    ' collapsed stars to be Supernova.': '坍缩星辰后可以成为超新星。',
    'Quantum Foam': '量子泡沫',
    ...
    'When Big Rip the Dimension, Entropy Rewards don’t work, all Primordium effects are 50% weaker except Epsilon Particles that don’t work, tree [qu2, qu10] doesn’t work, and you are trapped in Quantum Challenge with modifiers [10,2,10,10,5,0,2,10].\n            Death Shards are gained based on your normal mass while Big Ripped.\n            Unlock various upgrades from Big Rip.': '大撕裂维度后，熵的加成失效，所有原基粒子的效果减半，艾普西隆粒子完全失效，中子树升级[qu2]和[qu10]失效，且您强制以[10,2,10,10,5,0,2,10]的配置进行量子挑战。但大撕裂维度后，您可以根据质量获得死寂碎片。您可以使用死寂碎片解锁新升级。',
    'Dark Ray': '暗射线',
    ' Abyssal Blot.': '深渊之渍。',
    'Require ': '需要',
    'Oganesson-118': '气奥(118Og)',
    ' to go Dark.': '才能融入黑暗。',
    'Pre-Quantum Global Speed': '量子之前所有资源获取速度',
    'Speeds pre-Quantum resources\' production. (after exponent & dilation, etc.)': '加快量子之前所有资源获取速度。(在计算完指数和膨胀等之后的数值)',
    'Final Star Shard (FSS': '最终星辰碎片(物质',
    'Your Final Star Shard\'s base is ': '您的最终星辰碎片基础值为',
    ' of FSS\'s base to get Final Star Shard.': '最终星辰碎片基础值才能获得最终星辰碎片。',
    'Corrupted Shard': '腐化碎片',
    'Your best mass of black hole in 16th Challenge is ': '您在挑战16中最高的黑洞质量为',
    'Start the 16th Challenge. Earn ': '进入挑战16以后，可以根据黑洞质量获得',
    ' based on your mass of black hole, when exiting that challenge and reaching ': '，这需要在退出挑战时达到',
    //#endregion
    //#region 统计
    'Rank': '级别',
    'Tier': '阶层',
    ...
    '• You cannot gain Rage Power nor dark matters, and all matters’ formula is disabled, and they generate each other. Red matter generates dark matter.': '• 您无法获得狂怒能量和暗物质，所有物质的公式都被禁用，它们会互相产生彼此。红色物质可以产生暗物质。',
    '• Pre-C16 following contents (including rank & prestige tiers, main upgrades, elements, tree and etc.) are corrupted like disabled.': '• 挑战16之前的相应内容(包括级别、转生、主要升级、元素、中子树等等)受到了腐化，就像效果被禁用了一样',
    '• You are trapped in Mass Dilation & Dark Run with 100 all glyphs (10 slovak glyphs).': '• 您强制进行质量膨胀和黑暗狂奔，所有雕文(除了斯洛伐克雕文为10)为100。',
    '• Primordium particles disabled.': '• 原基定理被禁用。',
    '• Pre-Quantum global speed always sets to /100.': '• 量子之前所有资源获取速度常时为/100。',
    'You can earn Corrupted Shard based on your mass of black hole, when exiting the challenge.': '您可以根据退出挑战时的黑洞质量获得腐化碎片。',
    '[Corrupted]': '[已腐化]',
    ...
    'Entering challenge will supernova reset.': '进入挑战时将同时在未成为超新星的前提下重置！',
    'Entering challenge will force a Darkness reset.': '进入挑战时将强制融入黑暗！',
    'Entering challenge will force a FSS reset.': '进入挑战时将强制进行最终星辰碎片重置。',
    ...
    'Tickspeed power boosts base from Star Booster at a reduced rate.': '使时间速度倍率可以加成星辰发生器的基础加成，只是效果倍率降低。',
    ...
    'Ultra rank scaling starts 3 later for every supernova.': '每有一次成为超新星，级别的超究折算就延迟3次出现。',
    ...
    'Collapsed star boosts quarks gain.': '使坍缩星辰可以加成夸克获取速度。',
    ...
    'All tickspeed scalings starts 100x later (after nerf from 8th QC modifier).': '使时间速度的所有折算延迟100倍出现(在计算量子挑战8的削弱之后生效)。',
    ...
    'Death Shard gain is increased by 10% for every supernova.': '每有一次成为超新星，死寂碎片获取速度就增加10%。',
    ...
    'You can now automatically complete Challenges 12.': '您可以自动完成挑战12。',
    'Unlock 13th Challenge. Automate big rip upgrades.': '解锁挑战13。您可以自动购买大撕裂升级。',
    'Make 3, 4 & 8 Challenges’ effect better.': '使挑战3、挑战4和挑战8的奖励效果变得更好。',
    'Super Prestige Level & Honor is 5% weaker.': '使转生等级和荣耀的超级折算弱化5%。',
    'Dark shadow gain is boosted by death shard.': '使黑暗之影获取速度基于死寂碎片的数值而增加。',
    'You can now gain relativistic energy outside Big Rip. Keep quantum tree non-QoL on entering any dark challenge.': '您可以在大撕裂外获得相对论能量了。进入黑暗挑战时可以保留中子树量子后解锁升级中的非QoL升级。',
    ...
    'Unlock 14th Challenge.': '解锁挑战14。',
    'Prestige base boost dark rays earned.': '使转生基础值可以加成暗射线获取速度。',
    'Quantum shard’s base is increased by the number of elements bought.': '使量子碎片的基础效果指数基于购买的元素数量而增加。',
    'Outside Big Rip, you can now gain death shards. Automate cosmic strings.': '您可以在大撕裂外获得死寂碎片了。您可以自动购买宇宙弦。',
    ...
    'Collapsed star’s effect now provide an exponential boost at reduced rate. It can apply to mass of black hole gain. But nullify Palladium-46, Cadmium-48, Thulium-69 & Osmium-76.': '使坍缩星辰的效果变为指数加成，但效果倍率降低。它可以对黑洞质量获取速度生效。使钯(46Pd)、镉(48Cd)、铥(69Tm)和锇(76Os)失效。',
    ...
    'Each matter’s gain is increased by 10% every OoM^2 of dark matter. Unlock more main upgrades.': '暗物质每有一个数量级的二次方，就使每种物质的获取速度增加10%。解锁更多主要升级。',
    ...
    'You can now automatically evaporate resources. (Stronger than manual).': '您可以自动消耗资源了。(效果比手动更好)',
    'Double dark shadows gain.': '使黑暗之影获取速度翻倍。',
    'Muon-Catalyzed Fusion Tier ': 'μ子催化聚变阶层',
    ' Exotic Atoms (Kaon & Pion based).': '奇异原子(基于K介子和π介子数量)。',
    ' Kaons.': 'K介子。',
    ' Pions.': 'π介子。',
    ...
    'Star boost\'s Tetr\'s softcap is 50% weaker.': '使星辰加成的四重阶层的软上限弱化50%。',
    ...
    'Challenge 9th effect is better.': '使挑战9的奖励效果变得更好。',
    ...
    'On Active: You are trapped in Mass Dilation, but they are twice as effective': '激活时，强制进行质量膨胀，但它的效果翻倍',
    ...
    'Pre-Quantum global speed affects blueprint particle and chroma at a reduced rate.': '使量子之前所有资源获取速度可以加成蓝图粒子和色度获取速度，只是效果倍率降低。',
    ...
    'Makes you becoming ': '使您成为超新星的次数变为原来的',
    ' more supernovas': '',
    ...
    'Raises Exotic Atom\'s formula bu ': '使奇异原子的公式增加',
    ...
    'Cosmic ray effect is now exponent at super reduced rate.': '使宇宙射线效果变为指数加成，但效果倍率超级降低。',
    ...
    'Remove all scalings from BHC. [Neut-Tau]\'s effect no longer affects BHC\'s cheapness. In C16, BHC is 1,000,000x cheaper.': '移除黑洞压缩器的所有折算。使[陶中微子]的效果不再影响黑洞压缩器。在挑战16中，黑洞压缩器便宜1e6倍。',
    ...
    'Incremental Mass Rewritten v0.6.5.2 - made by MrRedShark77': '质量增量重制版v0.6.5.2 - 作者为MrRedShark77，由by22dgb汉化',
