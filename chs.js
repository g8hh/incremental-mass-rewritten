...
var cnItems = {
    ...
    '[Americium] Epsilon Particles are worked in Big Rip, but 90% weaker.': '[镅]使艾普西隆[E]粒子可以在大撕裂中生效，但弱化90%。',
    ...
    '[Seaborgium] Entropic Evaporation^2 and Condenser^2 scale 15% weaker.': '[𬭳]使熵消耗²和熵压缩²的折算弱化15%。',
    '[Bohrium] Beta Particles are twice effective.': '[𬭛]使贝塔[B]粒子效果翻倍。',
    '[Hassium] All scalings from Ranks to Pent scale 10% weaker (only 2% during Big Rip).': '[𬭶]从级别到五重阶层的所有折算弱化10%(大撕裂时只弱化2%)。',
    '[Meitnerium] Entropic Multiplier is effective, even in Big Rip.': '[䥑]使熵加倍在大撕裂时也生效。',
    '[Darmstadium] Mass gain softcap^4 is 50% weaker (only 20% in Big Rip).': '[𫟼]使质量获取速度的四重软上限弱化50%(大撕裂时只弱化20%)。',
    '[Roeritgenium] Neutron Stars raise Atom gain.': '[𬬭]使中子星可以加成原子获取速度。',
    '[Copernicium] [sn4] effect is increased by 2.': '[鎶]使[sn4]的效果增加2。',
    '[Nihonium] [bs2] uses a better formula.': '[鉨]使[bs2]的公式变得更好。',
    'inactive': '未激活',
    ...
    'Triple Relativistic Energies gain.': '使相对论能量获取速度变为3倍。',
    ...
    'Incremental Mass Rewritten v0.5.4.7 - made by MrRedShark77': '质量增量重制版v0.5.4.7 - 作者为MrRedShark77，由by22dgb汉化',
...
var cnRegReplace = new Map([
    ...
    [/^Boosts Mass gain by (.+)x$/, '使质量获取速度变为$1倍'], //原子等
    [/^Boosts Mass gain by \^(.*)$/, '使质量获取速度变为$1次方'], //原子等
    [/^Adds Tickspeed Power by (.+)%$/, '使时间速度倍率增加$1%'], //原子等
    [/^Boosts Rage Power gain by (.+)x$/, '使狂怒能量获取速度变为$1倍'], //原子等
    [/^Boosts Rage Power gain by \^(.*)$/, '使狂怒能量获取速度变为$1次方'], //原子等
    [/^Makes Mass gain boosted by Rage Powers - (.+)x$/, '使狂怒能量可以加成质量获取速度 - 倍率为$1倍'], //原子等
    [/^Boosts Dark Matter gain by (.+)x$/, '使暗物质获取速度变为$1倍'], //原子等
    [/^Boosts Dark Matter gain by \^(.*)$/, '使暗物质获取速度变为$1次方'], //原子等
