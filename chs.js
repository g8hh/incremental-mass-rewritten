...
var cnItems = {
    ...
    'Which increases pre-Quantum global speed by ': '它将使量子之前所有资源获取速度变为',
    'Cosmic Strings [': '宇宙弦[',
    ' Quantum Foam': '量子泡沫',
    ...
    'Super Mass Upgrades scaling is weaker by Rage Points.': '使质量升级的超级折算基于狂怒能量的数值而弱化。',
    ...
    'Hyper Mass Upgrade & Tickspeed scales 15% weaker.': '使质量升级和时间速度的究级折算弱化15%。',
    ...
    'Incremental Mass Rewritten v0.5 - Quantum Update - made by MrRedShark77': '质量增量重制版v0.5 - 量子升级 - 作者为MrRedShark77，由by22dgb汉化',
